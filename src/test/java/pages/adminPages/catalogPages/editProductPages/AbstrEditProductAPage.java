package pages.adminPages.catalogPages.editProductPages;
...
public class AbstrEditProductAPage extends AbstrCatalogAdminPage {

    public AbstrEditProductAPage(WebDriver driver) {
        super(driver);
    }
